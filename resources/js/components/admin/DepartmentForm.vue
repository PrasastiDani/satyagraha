...
<template>
    <form class="space-y-6" @submit.prevent="submit">
        <div class="rounded-[1.75rem] border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
            <div class="mb-8">
                <h2 class="text-satya-dark font-serif text-xl">Informasi Departemen</h2>

                <p class="mt-1 text-sm text-gray-400">Masukkan informasi departemen yang digunakan pada lowongan kerja.</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <div class="mb-2 flex items-center justify-between gap-4">
                        <label for="description" class="block text-[10px] font-black tracking-[0.14em] text-gray-500 uppercase"> Deskripsi </label>
                    ...
                    <textarea
                        ...
                        rows="6"
                        maxlength="2000"
                        placeholder="Jelaskan fungsi atau ruang lingkup departemen..."
                ...
                <div class="flex items-center justify-between gap-4 rounded-2xl border border-gray-200 bg-gray-50 px-5 py-4">
                    <div class="min-w-0">
                        <p class="text-sm font-semibold text-gray-700">Status Departemen</p>

                        <p class="mt-1 text-xs leading-5 text-gray-400">Departemen aktif dapat dipilih saat membuat lowongan kerja.</p>
                    </div>
                ...
                <p v-if="form.errors.is_active" class="mt-2 text-xs text-red-500">
        ...
        <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            ...
            >
                ...
                {{ form.processing ? 'Menyimpan...' : isEdit ? 'Simpan Perubahan' : 'Tambah Departemen' }}
            </button>
        </div>
    </form>
</template>
